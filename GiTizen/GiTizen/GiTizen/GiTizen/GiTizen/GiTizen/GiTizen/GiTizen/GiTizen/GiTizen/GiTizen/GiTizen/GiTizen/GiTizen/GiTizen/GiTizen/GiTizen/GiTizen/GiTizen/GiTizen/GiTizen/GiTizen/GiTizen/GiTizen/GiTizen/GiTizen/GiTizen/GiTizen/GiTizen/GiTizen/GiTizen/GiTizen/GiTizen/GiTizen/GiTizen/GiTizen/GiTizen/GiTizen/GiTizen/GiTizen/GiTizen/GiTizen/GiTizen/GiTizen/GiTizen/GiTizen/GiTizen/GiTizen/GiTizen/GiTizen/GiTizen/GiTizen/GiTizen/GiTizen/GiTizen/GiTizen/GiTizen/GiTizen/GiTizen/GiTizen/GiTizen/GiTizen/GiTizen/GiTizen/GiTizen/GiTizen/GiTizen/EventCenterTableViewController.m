...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self) {
        ...
        //self.eventCell = [[[NSBundle mainBundle] loadNibNamed:@"EventCell" owner:self options:nil] lastObject];
    }
    return self;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    self.eventCell = [tableView dequeueReusableCellWithIdentifier:@"EventCell"];// forIndexPath:indexPath];
    
    NSLog(@"array: %@", [[NSBundle mainBundle] loadNibNamed:@"EventCell" owner:self options:nil]);
    NSLog(@"last object: %@", [[[NSBundle mainBundle] loadNibNamed:@"EventCell" owner:self options:nil] lastObject]);
    self.eventCell = [[[NSBundle mainBundle] loadNibNamed:@"EventCell" owner:self options:nil] lastObject];
...
- (IBAction)refresh:(id)sender {
    //NSLog(@"returned object: %@", self.pizzas);
    [self loadPizzas];
}
 */
